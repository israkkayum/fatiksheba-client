...
import Answers from "../../QuestionsAnswers/Answers/Answers";
import AnswerBox from "../../QuestionsAnswers/AnswerBox/AnswerBox";
  ...
  return (
    <Paper elevation={1}>
      <div className="bg-white rounded mb-3">
        <CardContent>
          <blockquote class="block mt-1 text-lg font-medium text-black cursor-pointer leading-normal">
            {question}
          </blockquote>
        </CardContent>
